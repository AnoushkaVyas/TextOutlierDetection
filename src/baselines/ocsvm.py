...
class OCSVM(object):
    ...
    def train(self, dataset: BaseADDataset, device: str = 'cpu', n_jobs_dataloader: int = 0):
        ...
        train_loader, _ = dataset.loaders( num_workers=n_jobs_dataloader)
        ...
        for data in train_loader:
            ...
            X_batch = self.embedding(text, weights)  # X_batch.shape = (dataset_size,, embedding_size)
    ...
    def test(self, dataset: BaseADDataset, device: str = 'cpu', n_jobs_dataloader: int = 0):
        ...
        _, test_loader = dataset.loaders(num_workers=n_jobs_dataloader)

...
def build_network(net_name, dataset, embedding_size=None, pretrained_model=None, update_embedding=True,
                  ...
                  word_vectors_cache='../data/word_vectors_cache', attention_size=100, n_attention_heads=1,clusters=4):
    ...
    if net_name == 'cvdd_Net':
        net = CVDDNet(embedding, attention_size=attention_size, n_attention_heads=n_attention_heads,clusters=clusters)
